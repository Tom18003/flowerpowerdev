    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top ">
        <div class="container">
            <div class="navbar-translate">
                <a href="../website/Electicks Website/page/home.php" class="navbar-brand" rel="tooltip" title="Flower Power" data-placement="bottom" target="">
                    Flower Power
                </a>
...
?>   
    <div class="row-sm-3">
        ...
        <div class="caption">
          ...
          <h6><a style="color:white; background-color:#f96332;" class="btn btn-round" title="Product bekijken" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>Product bekijken</a><medium class="pull-right">€<?php echo $res['prod_price']; ?></medium></h6>
        </div>
