        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <hr color="orange">
                      <a href='admin_panel.php' class='btn btn-warning btn-round'>Home</a>
                <br>
                <div class="col-md-12">

    <div class="panel panel-success panel-size-custom">
  <div class="panel-heading"><h3>Leverancier bijwerken</h3></div>
        ...
        <div class="form group">
            ...
            <div class="form group">
                <button type="submit" class="btn btn-success btn-round" id="submit" name="update">
                    <i class="now-ui-icons ui-1_check"></i> Leverancier bijwerken
                </button>
            </div>
    </form>
  </div>
