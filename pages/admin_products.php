        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="admin_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Home</a>
                      <hr color="orange"> 
                <div class="col-md-12">
                <br>
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                if ($prod_qty<=10){
                                                ?>
                                                 <td><span style="color:red;"><?php echo $res['prod_qty'];?> : Tijdelijk niet leverbaar!</span></td>  
                                                 <?php
                                                }else{
                                               ?>
                                               ...
                                               <?php }
                                                ...
                                                echo "<td><a href=\"admin_product_details.php?prod_id=$res[prod_id]\">Product bekijken</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
                                </table><br><br><br><br>
