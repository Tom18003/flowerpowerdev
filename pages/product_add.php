...
<div class="panel panel-success panel-size-custom">
          <div class="panel-heading"><h3>Voeg producten toe</h3></div>

          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    <label for="prod_name">Product naam:</label>
                    <input type="text" class="form-control" id="prod_name" name="prod_name" placeholder="Product naam"/>
                    <label for="prod_desc">Product Beschrijving:</label>
                    <input type="text" class="form-control" id="prod_desc" name="prod_desc" placeholder="Product beschrijving"/>
                    <label for="prod_cost">Product kosten (€):</label>
                    ...
                    <label for="prod_qty">Aantal:</label>
                    ...
                    <label for="prod_serial">Serie nummer:</label>
                ...
                <div class="form group">
                    ...
                    <i class="now-ui-icons ui-1_check"></i> Product toevoegen
                    </button> 
                </div>
            </form>
          </div>
