        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <hr color="orange">
                      <a href='admin_panel.php' class='btn btn-warning btn-round'>Terug naar home</a>
                <br>
                <div class="col-md-12">

    <div class="panel panel-success panel-size-custom">
  <div class="panel-heading"><h3>Vaoeg aantal toe</h3></div>
  <div class="panel-body">
    <form action="product_add_qty.php" method="post">
        <div class="form group">
            ...
            <label for="prod_name" id="prod_name" name="prod_name">Product naam: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $prod_name;?></label><br><br>
            <label for="prod_serial">Product serie nummer: &nbsp &nbsp &nbsp <?php echo $prod_serial;?></label><br><br>
            <label for="prod_name">Naam: &nbsp &nbsp &nbsp <?php echo $prod_name;?></label><br><br>
            <label for="prod_desc">Beschrijving: &nbsp &nbsp &nbsp <?php echo $prod_desc;?></label><br><br>
            <label for="prod_price">Product Prijs (Php): &nbsp &nbsp &nbsp &nbsp <?php echo $prod_price;?></label><br><br>
            <label for="category">Product Leverancier: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $category;?></label><br><br>
            <label for="supplier">Product Catogorie: &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $supplier;?></label><br><br>
            <label for="qty">Available aantal: &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $prod_qty;?></label><br><br>
            <label for="prod_qty">Nummer voor aantal dat moet worden toegevoegd:</label>
        ...
        <div class="form group">
            ...
            <i class="now-ui-icons ui-1_check"></i> Voeg aantal toe
            </button> 
        </div>
    </form>
