...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Home" data-placement="bottom" target="">
                    Flower Power
                </a>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/backwall.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        >
                        <br><br>
                        <h1 style="font-weight: bold;">Flower Power</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Bloemen en Planten</h2>
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a style="color:white; background-color:#f96332;" class="btn btn-round" title="Product bekijken" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>Product bekijken</a><medium class="pull-right">€<?php echo $res['prod_price']; ?></medium></h6>
                                </div>
