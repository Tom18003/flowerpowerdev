    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Home" data-placement="bottom">
                    Flower Power
                </a>
...
?>
    ...
    <div class="page-header" filter-color="">
        <div class="page-header-image" style="background-image:url(../assets/img/backwall.jpg)"></div>
        <div class="container">
                    ...
                    <form class="form" method="post" action="">
                        ...
                        <div class="content">
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="firstname" class="form-control" placeholder="Voor naam" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons users_circle-08"></i>
                                </span>
                                <input type="text" name="middlename" class="form-control" placeholder="Voorletter(s)" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons users_circle-08"></i>
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="contact" class="form-control" placeholder="Telefoon" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="password" id="password" name="password" placeholder="Wachtwoord" class="form-control"  required>
                            </div>
                        </div>
