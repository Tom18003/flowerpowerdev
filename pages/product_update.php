        ...
        <div class="form group">
            ...
            <input type="text" class="form-control" id="prod_price" name="prod_price" value="<?php echo $prod_price;?>">
                    ...
                    <div class="form-group">
                        ...
                        <label for="prod_qty" id="prod_qty" name="prod_qty">Aantal op voraat: &nbsp &nbsp <?php echo $prod_qty;?> Pcs.</label>
                    </div>
                </div>            
             </div>
            </div>
            ...
            <div class="form group">
                <button type="submit" class="btn btn-success btn-round" id="submit" name="update">
                    <i class="now-ui-icons ui-1_check"></i> Product updaten
                </button>
            </div>
    </form>
  </div>
