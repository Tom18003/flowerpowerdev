...
<div class="panel panel-success panel-size-custom">
          <div class="panel-heading"><h3>Voeg leverancier toe</h3></div>

          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    <label for="supp_name">Naam leverancier:</label>
                    <input type="text" class="form-control" id="supp_name" name="supp_name" placeholder="Naam"/>
                    <label for="supp_address">Adres:</label>
                    <input type="text" class="form-control" id="supp_address" name="supp_address" placeholder="Adres"/>
                    <label for="supp_contact">Telefoon:</label>
                ...
                <div class="form group">
                    ...
                    <i class="now-ui-icons ui-1_check"></i> Leverancier updaten
                    </button> 
                </div>
            </form>
          </div>
