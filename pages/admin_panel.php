...
<body class="profile-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Admin Home" data-placement="bottom" target="">
                    Flower Power
                </a>
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/backwall.jpg');"></div>
                <div class="container">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    <a href="" class="btn btn-primary btn-round btn-lg">Volg me op</a>
               ...
               <div class="row">
                    <div class="col-md-6 ml-auto mr-auto">
                        <h4 class="title text-center">Medewerker Dashboard</h4>
                    ...
                    <div class="tab-content gallery">
                        <div class="tab-pane active" id="products" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="product_add.php"><i class="now-ui-icons ui-1_simple-add"></i> Product toevoegen </a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="supplier" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="supplier_add.php"><i class="now-ui-icons ui-1_simple-add"></i> Voeg leverancier toe </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="admin_accounts" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="admin_signup.php"><i class="now-ui-icons ui-1_simple-add"></i> Voeg medewerker toe </a>
                                </div>
                            </div>
                        </div>
                    </div>
