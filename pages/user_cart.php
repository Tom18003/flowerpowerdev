        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons shopping_basket"></i> &nbsp Verder winkelen</a>
                      <hr color="orange"> 
      ...
      <table class="table table-condensed table-bordered">
              <thead>
                <tr>
                  ...
                  <th width="100">Prijs</th>
                  <th width="100">Totaal</th>
                  <th width="100">Optie</th>
                </tr>
              </thead>
          ...
          ?>
              ...
              <tr>
                  ...
                  <td>     
                    <a href="edit_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-warning btn-round" type="button">aantal updaten</button></a>
                     <a href="delete_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-danger btn-round" onclick="return confirm('Are you sure you want to delete?')" type="button">verwijderen</button></a>
                  </td>
              ...
              <tr>
                  <td></td>
                  <td></td>
                  <td colspan="2" align="right"><b>Totaal</b></td>
            ...
            ?>
                ...
                <i class="now-ui-icons shopping_bag-16"></i> Bestellen</button> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-round" data-dismiss="modal">Sluiten</button>
                    <a><button type="submit" name="submit" class="btn btn-success btn-round"><i class="now-ui-icons shopping_delivery-fast"></i> Bestellen</button></a>
                  </div>
              </div>
            </div>
            </div>
