...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Terug naar home</a>
            <hr color="orange">
            <div class="col-md-12">
...
?>   
       ...
       ?>
       <b>Aantal op voraat: </b><?php echo $res['prod_qty'];?>
       </ul>
       <?php 
    }
?>
        <?php }?> 
            ...
            <button class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal">
                <i class="now-ui-icons shopping_cart-simple"></i>Toevoegen aan winkelwagen</button>
              ...
              <div class="modal-dialog">
                ...
                <div class="form group">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Aantal invoegen:</h4>
                  </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <a><button type="submit" name="submit" class="btn btn-success btn-round">Bestellen</button></a>
                  </div>
                </div>
                </form>
